...

{
	...
	do {
		...
		if (iResult > 0) {
			char messageBuffer1[512]; //making a new character string of size that (probably) won't go over, shiftig in here so can put null character at end so not a bunch of gobaldygook at the end
			...
			char messageBuffer2[512]; //making a new character string of size that (probably) won't go over, shiftig in here so can put null character at end so not a bunch of gobaldygook at the end
